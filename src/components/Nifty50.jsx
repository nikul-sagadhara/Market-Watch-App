...
import useNifty50Data from '../utils/useNifty50Data'

const Nifty50 = () => {
    const {marketData} = useNifty50Data();
  return (
    <div className='w-11/12 mx-auto overflow-auto'>
    <table className="table-auto border-collapse border border-slate-500 my-8 w-full">
